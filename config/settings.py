...
SECRET_KEY = 'django-insecure-#0b2yzpp6w#p71_wo(en%n6#0uq0k*y3$fwvwgb5a66lfcv2fe'
...
DATABASES = {
    'default': {
        ...
        'NAME': BASE_DIR / 'db.sqlite3',  # This points to the SQLite file in your project folder
    }
}
...
STATICFILES_DIRS = [
    BASE_DIR / 'gatepass' / 'static' / 'branding',
]
